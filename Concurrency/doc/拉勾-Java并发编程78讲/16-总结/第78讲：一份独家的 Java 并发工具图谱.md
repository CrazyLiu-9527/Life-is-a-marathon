...
在了解了线程池的好处之后，就需要掌握线程池的**各个参数的含义**，即 corePoolSize、maxPoolSize、keepAliveTime、workQueue、ThreadFactory、Handler，并且这也是面试中**非常常见的考点**，我们需要知道每个参数代表什么含义。
