...
![面试官：小伙子，听说你看过ThreadLocal源码？（万字图文深度解析ThreadLocal）](pic/v2-f3e28d3f3090af7a27dda0186779a345_1200x500.jpg)



原文：[https://www.cnblogs.com/wang-meng/p/12856648.html](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/wang-meng/p/12856648.html)



## 前言

![img](pic/v2-0e5b47a4b92b9190cdd996744ef47ae8_720w.jpg)

前几天写了一篇`AQS`相关的文章：[我画了35张图就是为了让你深入 AQS](https://zhuanlan.zhihu.com/p/139844114)，反响不错，还上了**博客园首页编辑推荐**，有生之年系列呀，哈哈。

![img](pic/v2-7cc54e9454a1e277e9be6e09d9f82d6a_720w.jpg)
...
![img](pic/v2-18e54f5f29879278984d42f90d511b30_720w.jpg)
...
![img](pic/v2-631cc15bbf0b0707d7c9b63843ffc554_720w.jpg)
...
![img](pic/v2-18e5d0cecc366ec878199db4239c855b_720w.jpg)
...
![img](pic/v2-a6bc71b9466e1ad204e04654d70a7210_720w.jpg)

如果我们的**强引用**不存在的话，那么 `key` 就会被回收，也就是会出现我们 `value` 没被回收，`key` 被回收，导致 `value` 永远存在，出现内存泄漏。

### **ThreadLocal.set()方法源码详解**

![img](pic/v2-3da2f8a31c8932560d2b7f4c8c4e2702_720w.jpg)
...
![img](pic/v2-5d54181d97708351404e09fd4103bf38_720w.jpg)
...
![img](pic/v2-ec2b110a79cccd5cd0fb0ca236e4e54b_720w.jpg)
...
![img](pic/v2-81305cc7fc01391ff0c20756f44dc720_720w.jpg)
...
![img](pic/v2-44af10b43d7d14d10839e26e3a85f0b0_720w.jpg)
...
![img](pic/v2-f04e78cbff590eccbbd258a93eaac6d8_720w.jpg)
...
![img](pic/v2-6e7f5fb8fabf29e7ce83d53a62b1089f_720w.jpg)
...
![img](pic/v2-91c5c618e8905079e39c79696f8b6bc3_720w.jpg)
...
![img](pic/v2-a9961d376656e1776b82cd44bd2f728e_720w.jpg)
...
![img](pic/v2-ee8513b6938f6f97e294ed3881df50fb_720w.jpg)



**向后遍历过程中，如果没有找到相同key值的Entry数据：**

![img](pic/v2-a7ee69745cc1dd3d21d729d3a58181d7_720w.jpg)
...
![img](pic/v2-cf01374498fe3f5cdf5a7568047cd8d0_720w.jpg)
...
![img](pic/v2-e8c8723e0d78f48b70cce7d062185bc6_720w.jpg)
...
![img](pic/v2-1a65914b8fb6706057ba8b7009f57170_720w.jpg)
...
![img](pic/v2-e5ed96b0377eea15b83616e7bd8585ac_720w.jpg)
...
![img](pic/v2-0e94d8ad9dcaa70e77706c5b37e32e86_720w.jpg)



我们假设`expungeStaleEntry(3)` 来调用此方法，如上图所示，我们可以看到`ThreadLocalMap`中`table`的数据情况，接着执行清理操作：

![img](pic/v2-cbb36bbf105e20f2c9f5d8a977e8d006_720w.jpg)



第一步是清空当前`staleSlot`位置的数据，`index=3`位置的`Entry`变成了`null`。然后接着往后探测：

![img](pic/v2-c674c41c5410e46af4e1c1d0b6d00d3b_720w.jpg)
...
![img](pic/v2-7492d9d693426510c2a911c1e3adaf51_720w.jpg)
...
![img](pic/v2-3d22f981e903296280d0124cbb1fe94f_720w.jpg)



接着看看具体的`resize()`方法，为了方便演示，我们以`oldTab.len=8`来举例：

![img](pic/v2-c3bc4bfc5a640e109f800ea64fe31268_720w.jpg)
...
![img](pic/v2-58bdeca2144a9880ce88921b0fac27f6_720w.jpg)



**第二种情况：** `slot`位置中的`Entry.key`和要查找的`key`不一致：

![img](pic/v2-d1d9940880ae6f05c35a0fe5dc2e7e5a_720w.jpg)
...
![img](pic/v2-01def6756fa50e50872e9ac45788222a_720w.jpg)
...
![img](pic/v2-24cdffbc8b72bc24006144701f50a7d0_720w.jpg)
...
![img](pic/v2-77572eddc6f1b8621e42212835817365_720w.jpg)
...
![img](pic/v2-2b74eb520efefa8f35dce3a11506d3fb_720w.jpg)
...
在MQ发送的消息体中自定义属性`requestId`，接收方消费消息后，自己解析`requestId`使用即