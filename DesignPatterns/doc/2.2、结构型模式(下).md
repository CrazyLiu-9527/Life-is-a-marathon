...
在上一篇文章 **[详解设计模式之结构型模式（上）](https://zhuanlan.zhihu.com/p/91836046)**中我们学习了三种结构型模式：适配器模式、桥接模式、组合模式。本文我们将介绍剩余四种结构型模式，它们分别是：
...
![img](pic/v2-b02e80f8c9e31c309cfa41ba191a0919_720w.jpg)
...
![img](pic/v2-35efe24140308ba0394d7758fd7546c4_720w.jpg)
...
![img](pic/v2-c75e41044733a59739f416b2100e21b7_720w.jpg)
...
![img](pic/v2-751d3caaf8f304bd67097a4d5a7888ce_720w.jpg)
...
到这里我们就将结构型模式介绍完了，下一篇我们将介绍行为型模式，有什么疑问欢迎在评论区留言，力扣君会一一进行回复。