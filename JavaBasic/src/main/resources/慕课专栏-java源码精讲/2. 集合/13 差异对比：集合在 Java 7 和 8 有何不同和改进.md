...
![图片描述](aHR0cDovL2ltZy5tdWtld2FuZy5jb20vNWQ3MDc5OGQwMDAxMGI2MTExOTQwMzY0LnBuZw)
...
1. ArrayList 无参初始化时，Java 7 是直接初始化 10 的大小，Java 8 去掉了这个逻辑，初始化时是空数组，在第一次 add 时才开始按照 10 进行扩容，下图是源码的差异对比图：
   ![图片描述](aHR0cDovL2ltZy5tdWtld2FuZy5jb20vNWQ3MDc5NDcwMDAxZWJmZDIwMDgwMjU0LnBuZw)List 其它方面 java7 和 8 并没有改动。
...
![图片描述](aHR0cDovL2ltZy5tdWtld2FuZy5jb20vNWQ3MDc4ZmUwMDAxYTZiNzI0NzIxMzIyLnBuZw)从图中，我们发现 LinkedHashMap 的方法名有所修改，底层的实现逻辑其实都差不多的。
