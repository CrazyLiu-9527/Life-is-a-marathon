...
4. 接口里面无需给方法写上 public 方法，因为接口中的方法默认都是 public 的，你写上编译器也会置灰，如下图：
   ![图片描述](pic/aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYjE0ZmFhMDAwMTkyODkwNDE0MDQ4NC5wbmc)
...
![图片描述](pic/aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYjE0ZmM3MDAwMTYxN2YwODY2MDcxMS5wbmc)
