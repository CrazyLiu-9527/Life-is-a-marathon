...
几个类整体的结构如下：
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYzM4MzZkMDAwMWU5ZTQwNzYyMDY5NC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYzM4MzRlMDAwMTBmMmIxNDAyMDYxMC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYzM4MzE5MDAwMTA2ZDcxMzA2MDQzMC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYzM4MmZmMDAwMTJkYjcwNTY2MDE4NC5wbmc)

我们需要注意的是 tryLock 无参方法底层走的就是非公平锁实现，没有公平锁的实现。

下图展示的是带有超时时间的有参 tryLock 的调用实现图：
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkYzM4MjRmMDAwMTkwNmQwODEyMDM3MC5wbmc)
