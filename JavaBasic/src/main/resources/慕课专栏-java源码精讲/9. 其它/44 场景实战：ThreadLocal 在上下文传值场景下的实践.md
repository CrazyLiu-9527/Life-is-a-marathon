...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMzk4MDAwMTI4OWExNjQwMTI0Ni5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMzc1MDAwMTZhYTkxNDUyMTI2MC5wbmc)
我们把两个 SpringBean 注册到流程注册中心中，让其按照先执行 BeanThree 再执行 BeanFive 的顺序进行执行，运行 DemoApplication 类的 main 方法进行执行，执行结果如下：

![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMzNmMDAwMTQ0ODQxNzgyMDIyOC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMzFlMDAwMTIwYjcxNzA2MDY2Ni5wbmc)
我们再来运行一下，打印的日志如下：
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMmY2MDAwMTUwMTYyMDA0MDUwMC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMmI4MDAwMTNmNmYyMDM2MDM5Mi5wbmc)

我们再次运行，结果如下：

![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMjk1MDAwMTM5NDQxNTAyMDIxNi5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMjZmMDAwMTgxMmExOTIyMTMwNC5wbmc)
为了能快速看到效果，我们把线程池的 coreSize 和 maxSize 全部修改成 3，并让任务沉睡一段时间，这样三个线程肯定消费不完任务，大量任务都会到队列中去排队，我们修改一下测试脚本，如下：
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMjM4MDAwMWE4MjQxMzk0MDM0MC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMjFmMDAwMTBkOWEyMDI2MDg3NC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMWVkMDAwMTJiMDExODEwMTM1MC5wbmc)

我们再次运行测试代码，运行的结果如下：

![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMWNmMDAwMWMwYmQxMDE1MDgyMC5wbmc)
...
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMTYxMDAwMWFmOGIwODAyMDkxNi5wbmc)
运行结果如下:
![图片描述](aHR0cHM6Ly9pbWcubXVrZXdhbmcuY29tLzVkZDYwMTNmMDAwMTc2M2IwOTM3MDgyMy5wbmc)
