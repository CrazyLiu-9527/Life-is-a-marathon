...
//        dogAnimalService.eat();
        ...
        AnimalService catServiceImpl = ApplicationContextHelper.getBean(EnumAnimalType.CAT.getBeanName(),CatAnimalServiceImpl.class);
        AnimalService dogServiceImpl = ApplicationContextHelper.getBean(EnumAnimalType.DOG.getBeanName(),DogAnimalServiceImpl.class);
        catServiceImpl.bark();
        dogServiceImpl.bark();
        System.out.println("==================");
